...
- Add a separate programme-experience check-in after an actually shared demo, recording or class link. Default delay: **18 hours**, configurable with `experience_followup_wait_hours` / `NEXTGEN_EXPERIENCE_FOLLOWUP_WAIT_HOURS` (6–72 hours). This is NOT the 4–5-hour payment reminder.
