...
test("the managed WhatsApp pack contains the eight campaign templates", () => {
  ...
  assert.match(sessionLink?.body || "", /scheduled NextGen class/);
  assert.match(sessionLink?.body || "", /Join using this class link/);
  ...
  assert.match(recordingLink?.body || "", /Open the recording here/);
