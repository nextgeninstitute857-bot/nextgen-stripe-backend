...
test("AylaMed Vimeo privacy keeps staging access and adds both production hosts", () => {
  ...
  assert.match(server, /function aylaPrivatePilotVimeoEmbedDomains\(\)[\s\S]{0,650}"https:\/\/www\.aylamedapp\.com"/);
});
