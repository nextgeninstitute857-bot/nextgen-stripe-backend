...
test('past holiday is preview-locked, blocks teaching evidence, and preserves attachments and student work', {timeout: 70000}, async () => {
  ...
  for (const cid of ['safe','notes','attendance','unpublished']) {
  ...
  try {
    ...
    for(const cid of ['notes','attendance','unpublished']){
