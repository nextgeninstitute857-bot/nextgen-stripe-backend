...
export function registryQuestionToFlashcard(question = {}, { courseId = "", reviewed = false } = {}) {
  ...
  return {
    ...
    source_year: Number(question.source_year || 0) || null,
    front: flashcardTextOnlyHtml(question.question_html),
    back: flashcardTextOnlyHtml(question.correct_answer_html),
    explanation: flashcardTextOnlyHtml(question.explanation_html),
    ...
    media: [],
    videos: [],
    media_omitted_for_flashcard: true,
