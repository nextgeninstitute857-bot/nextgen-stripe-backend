...
export function preserveMetaReportingForLegacyWrite(current = {}, incoming = {}) {
  ...
  for (const key of ["meta_ads_sync_state", "meta_ads_performance", "meta_ads_performance_by_brand", "meta_ads_last_sync", "meta_ads_last_sync_by_brand", "meta_ads_rollup_archive"]) {
