...
export async function updateContentCollectionControls({
  ...
  try {
    ...
    if (publishAllRequested && testingPhaseRelease === true && (
      ...
      || Number(readiness.answer_shape_ready_count || 0) !== questionCount
    )) {
      throw Object.assign(
        new Error('The all-students testing release requires complete taxonomy, five answers, and exactly one correct answer for every question'),
        {
          statusCode: 409,
          ...
          details: {
            ...
            answer_shape_ready_count: Number(readiness.answer_shape_ready_count || 0),
          },
        },
      );
    }
