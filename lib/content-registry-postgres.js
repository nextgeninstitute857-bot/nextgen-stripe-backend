  ...
  try {
    ...
    const collectionResult = await client.query(`
      INSERT INTO content_collections (
        ...
        source_rights_status,source_format,collection_key,title,status,
        destinations,display_policy,approved_at,approved_by
      )
      VALUES (
        $1,'usmle-step-1','aylamed_original','AylaMed','aylamed_original',
        'owned','single_best_answer_v1',$2,'AylaMed Original Image-MCQ Replacements',
      ...
      ON CONFLICT (exam_track,source_namespace,collection_key) DO UPDATE SET
        ...
        title=EXCLUDED.title,status='approved',destinations=EXCLUDED.destinations,
