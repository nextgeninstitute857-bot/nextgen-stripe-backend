...
import { MCCQE_DEMO_BRAND, mccqeDemoEnabled, mccqeDemoPurchaseState, mccqeDemoPilotEligibility } from "./crm-aylamed-demo-lifecycle.js";
...
export function assessMccqeWhatsAppIntake({ crmDb = {}, aylaDb = null, lead = {}, secret = "", now = Date.now(), expectedInboundId = "", reservedIssuanceId = "" } = {}) {
  ...
  if (!pilot.ok) return fail(pilot.reason);
