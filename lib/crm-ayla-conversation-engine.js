...
export function applyAylaConversationNameToLead(lead = {}, value = "", now = new Date().toISOString()) {
  ...
  if (currentName && !isGenericLeadName(currentName) && !providerOwned) return false;
