...
export function evaluateAylaConversationDecision({ decision = {}, state = {}, messages = [] } = {}) {
  ...
  if (
    /(?:feel free to (?:reach out|ask)|let me know if (?:you have|there are) any|do not hesitate to (?:reach out|ask)|i(?:'m| am) here if you (?:need|want|have))\b/i.test(combinedReply)
