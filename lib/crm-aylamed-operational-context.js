...
export function buildMccqeOperationalContext({ crmDb = {}, aylaDb = {}, lead = {}, now = Date.now() } = {}) {
  if (lead.brand_id !== MCCQE_DEMO_BRAND || !lead.id || !lead.ayla_user_id || !email(lead.email)) return {};
...
export function validateMccqeAutomaticOutbound({ lead = {}, messages = [], operationalContext = {}, text = "", subject = "", mediaUrl = "", mediaId = "", templateName = "" } = {}) {
