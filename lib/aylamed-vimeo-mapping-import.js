...
export const AYLA_VIMEO_MAPPING_ALLOWED_FOLDER_IDS = new Set([
  ...
  "30018662", // private intake; exam assignment required after authenticated inventory
  "30159726", // private intake; exam assignment required after authenticated inventory
  "30157751", // private intake; exam assignment required after authenticated inventory
  "30160677", // private intake; exam assignment required after authenticated inventory
  "30154270", // private intake; exam assignment required after authenticated inventory
  "30154281", // private intake; exam assignment required after authenticated inventory
  "30142803", // private intake; exam assignment required after authenticated inventory
  "30127339", // private intake; exam assignment required after authenticated inventory
]);
