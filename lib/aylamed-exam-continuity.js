...
export function buildAylaEngagementMessages({
  ...
  // Private CRM trials have an exact-hour, purchase-aware WhatsApp lifecycle.
  // Do not also send day-based renewal, expiry or reactivation emails.
  const privateCrmDemo = enrollment?.source === "crm_mccqe_demo";
  if (expiry && !privateCrmDemo) {
