const PACK_VERSION = "2026-08-31-eight-template-pack-v2";
...
export const NEXTGEN_WHATSAPP_TEMPLATE_PACK = Object.freeze([
  ...
  },
  {
    ...
    body: "Dr. {{name}}, the {{topic}} live class is starting now.\n\nJoin here:\n{{live_session_link}}\n\nEven 5–10 minutes is enough to experience the NextGen teaching style.",
  ...
  },
  {
    ...
    body: "Hi Dr. {{name}} 👋 If you missed today’s live class, the recording is now ready.\n\n{{full_session_name}}\n\nWatch here:\n{{recording_link}}\n\nWhen you’ve watched it, let me know what you thought of the teaching style.",
