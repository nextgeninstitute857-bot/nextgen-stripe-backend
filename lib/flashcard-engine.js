...
const FLASHCARD_MEDIA_CONTAINER_TAGS = [
  "audio",
  "canvas",
  "embed",
  "iframe",
...
export function flashcardTextOnlyHtml(value = "") {
  ...
  html = html.replace(/<img\b[^>]*>/gi, (tag) => {
    ...
    return alt ? escapeFlashcardText(alt[1] ?? alt[2] ?? alt[3] ?? "") : " ";
  });
  for (const tag of FLASHCARD_MEDIA_CONTAINER_TAGS) {
